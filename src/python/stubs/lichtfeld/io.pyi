...
def project_content_stamp(path: str | os.PathLike) -> str: ...
...
def encode_preview_from_image_file(image_path: str | os.PathLike) -> bytes: ...

def encode_preview_from_first_dataset_image(path: str | os.PathLike) -> bytes: ...

def encode_preview_from_first_embedded_image(path: str | os.PathLike) -> bytes: ...
