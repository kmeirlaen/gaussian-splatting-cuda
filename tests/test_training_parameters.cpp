...
namespace {
    ...
    TEST_F(TrainingParametersTest, ExperimentalErrorFieldsAreConfigResidue) {
        ...
        EXPECT_FALSE(default_json.contains("occ_vis_full"));
        ...
        EXPECT_FLOAT_EQ(parsed.occ_vis_full, 0.01f);
        ...
        EXPECT_FLOAT_EQ(enabled_json.at("occ_vis_full").get<float>(), 0.01f);
        ...
        EXPECT_FALSE(invalid.validate().empty());
        invalid = defaults;
        invalid.occ_vis_full = 0.0f;
        EXPECT_FALSE(invalid.validate().empty());
        invalid = defaults;
        invalid.occ_vis_full = 0.03f;
        invalid.occ_vis_off = 0.03f;
        EXPECT_FALSE(invalid.validate().empty());
        invalid = defaults;
        invalid.occ_vis_full = 0.04f;
        invalid.occ_vis_off = 0.03f;
        EXPECT_FALSE(invalid.validate().empty());
        invalid = defaults;
